    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          ...
          <img src="uploads/<?php echo $_SESSION['userimage']; ?>" 
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="userpos.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="userproductlist.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="userorderlist.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="userprintbill.php" class="nav-link">
